...
//		Reader in = new FileReader("path/to/file.csv");
		...
		for (CSVRecord record : records) {
 		   ...
 		   // int difference = latestCases- previousDayCases;
 		    
		    locationStats.setTotlaReportedCases(latestCases);
		    locationStats.setDiffFromPrevoiusDay(latestCases- previousDayCases);
